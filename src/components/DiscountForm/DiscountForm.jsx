...
import GetDiscButton from '../../components/Buttons/Get a discount/GetDiscButton';
import styles from './DiscountForm.module.css';
import discountImage from '../../assets/pets.png';
  ...
  return (
    <div className="Container">
      <div className={styles.discountFormContainer}>
        <h2 className={styles.form_title}>5% off on the first order</h2>
